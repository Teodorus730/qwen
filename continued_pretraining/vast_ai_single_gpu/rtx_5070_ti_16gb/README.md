# Qwen3-0.6B на RTX 5070 Ti 16 GB через Vast.ai

**Статус:** эксперимент от 29 июля 2026 года завершён и проанализирован.
...
```powershell
cd D:\HANDMADE_LLM\REPO\qwen\continued_pretraining\vast_ai_single_gpu\rtx_5070_ti_16gb
.\make_upload_zip.ps1
```
